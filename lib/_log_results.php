...
<section id='report-requests'>
	...
	<?php $log->displayTable($log->getRequestsList(), $log->getRequestsTotal(), ['URL', 'Nb requests'], true); ?>
</section>
...
<section id='report-requests404'>
	...
	<?php $log->displayTable($log->getRequests404List(), $log->getRequests404Total(), ['URL', 'Nb requests'], true); ?>
</section>
...
<section id='report-volume'>
	...
	<?php $log->displayTable($log->getBytesList(), $log->getBytesTotal(), ['URL', 'Nb requests', 'Data (Mo)'], true); ?>
</section>

<section id='report-ip'>
	<div class="page-header"><h1>IPs</h1></div>
	<?php $log->displayTable($log->getIpList(), $log->getRequestsTotal(), ['IP', 'Nb requests'], false); ?>
</section>

<section id='report-ua'>
	<div class="page-header"><h1>User Agents</h1></div>
	<?php $log->displayTable($log->getUaList(), $log->getRequestsTotal(), ['User Agent', 'Nb requests'], false); ?>
</section>
